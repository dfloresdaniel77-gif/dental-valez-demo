        ...
        <section className="relative py-24 md:py-48 bg-[#111111] overflow-hidden min-h-screen flex items-center">
            <div className="container max-w-[1220px] w-full px-6 md:px-10 relative z-10 mx-auto">
                ...
                >
                    ...
                    <motion.div
                        className={`relative mt-10 md:mt-0 mx-auto ${imageOrderClass} w-full max-w-[400px] md:max-w-[471px]`}
                        variants={itemVariants}
                    >
                        ...
                        >
                            {secondaryImageSrc && (
                                <div
                                    className="relative w-full h-full bg-cover bg-center rounded-[32px] opacity-50"
                                    style={{
